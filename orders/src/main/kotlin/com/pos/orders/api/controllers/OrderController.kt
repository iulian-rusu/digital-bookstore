...
class OrderController {
    ...
    @Operation(summary = "Update an existing order for a client")
    @ApiResponses(
        value = [
            ApiResponse(responseCode = "201", description = "Order updated"),
            ApiResponse(responseCode = "404", description = "Cannot find order"),
            ApiResponse(responseCode = "409", description = "A different error while processing the request")
        ]
    )
